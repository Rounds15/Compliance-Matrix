...
window.CM_METRICS = [
  /* Compliance Functions */
  {
    key: "functions",
    fallback: 391,
    dataverse: { set: "su_compliancefunctions", select: "su_compliancefunctionid", distinct: false, field: null, filter: "statecode eq 0" },
    sharepoint: { list: "Functions", distinct: false, field: null, filter: null }
  },
  /* Risk Areas */
  {
    key: "riskareas",
    fallback: 13,
    dataverse: { set: "su_riskareas", select: "su_riskareaid", distinct: false, field: null, filter: "statecode eq 0" },
    sharepoint: { list: "RiskAreas", distinct: false, field: null, filter: null }
  },
  /* Named Owners */
  {
    key: "owners",
    fallback: 148,
    dataverse: { set: "su_functionownerships", select: "su_functionownershipid", distinct: true, field: "_su_person_value", filter: "statecode eq 0" },
    sharepoint: { list: "FunctionOwners", distinct: true, field: "PersonID", filter: null }
  },
  /* Deadlines tracked */
  {
    key: "deadlines",
    fallback: 320,
    dataverse: { set: "su_compliancedeadlines", select: "su_compliancedeadlineid", distinct: false, field: null, filter: "statecode eq 0" },
    sharepoint: { list: "Deadlines", distinct: false, field: null, filter: null }
  },
  /* Governing statutes mapped */
  {
    key: "statutes",
    fallback: 209,
    dataverse: { set: "su_compliancefunctions", select: "su_compliancefunctionid", distinct: true, field: "su_statute", filter: "statecode eq 0" },
    sharepoint: { list: "Functions", distinct: true, field: "Statute", filter: null }
  },
  /* Executive owners */
  {
    key: "executives",
    fallback: 16,
    dataverse: { set: "su_functionownerships", select: "su_functionownershipid", distinct: true, field: "_su_person_value", filter: "statecode eq 0 and su_role eq 100000030" },
    sharepoint: { list: "FunctionOwners", distinct: true, field: "PersonID", filter: "Role eq 'Executive Owner'" }
  }
];
